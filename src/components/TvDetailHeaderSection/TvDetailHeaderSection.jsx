  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage: `url("https://www.themoviedb.org/t/p/w1920_and_h800_multi_faces${currentTvDetail.backdrop_path}")`,
        }}
      >
          ...
          <div className="container d-flex text-white py-4">
            ...
            <div className="right-section px-5 d-flex align-items-center">
              <div className="movie-title-section">
                <h2>
                  <Link to="/">{currentTvDetail.name} </Link>
                ...
                <div className="facts">
                  ...
                  <span className="runtime">
                    {currentTvDetail.episode_run_time >= 60
                      ? Math.floor(currentTvDetail.episode_run_time / 60) + "h "
                      : ""}
